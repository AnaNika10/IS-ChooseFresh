\subsubsection{Brisanje klijentskog naloga}
...
\begin{itemize}
    ...
    \item Alternativni tok:
        \begin{itemize}
			...
			\item[3.a] Ukoliko klijent ne unese validne podatke sistem ga obaveštava o grešci prilikom brisanja. Slučaj upotrebe se nastavlja od koraka 2.
        \end{itemize}
\end{itemize}
