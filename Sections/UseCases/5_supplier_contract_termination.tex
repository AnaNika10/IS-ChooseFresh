\subsection{Raskid ugovora na zahtev snabdevača}
...
\begin{itemize}
    ...
    \item Postuslovi:
        \begin{itemize}
            \item Uspešno je raskinut ugovor izmedju snabdevača i HelloFresh kompanije
            \item Snabdevač prestaje se uslugom dostavljanja namirnica.
            \item Nalog snabdevača je uklonjen iz sistema.
        \end{itemize}
    \item Glavni tok:
        \begin{enumerate}
            \item Snabdevač pristupa veb stranici i potvrdjuje raskid ugovora.
            \item Sistem obradjuje zahtev za raskid ugovora i obaveštava nekog od inspektora.
...
\subsection{Raskid ugovora na zahtev HelloFresh kompanije}
